...
const Header = () => {
    ...
    const drawer = (
        <Box sx={{ textAlign: 'center' }}>
            <Typography color={"green"} var="h6" component={"div"} sx={{ flexGrow: 1, my: 2, fontSize: "2rem" }}>
                <FastfoodIcon />
                My Fruits Shop
            </Typography>
            <Divider />
            ...
            <Box>
                <AppBar component={'nav'} sx={{ bgcolor: 'black' }}>
                    <Toolbar>
                        ...
                        <Typography color={"green"} var="h6" component={"div"} sx={{ flexGrow: 1, fontSize: "3rem",fontWeight:"bold" }}>
                            <FastfoodIcon />
                            My Fruits Shop
                        </Typography>
